...
import { isExamEnabled } from "@/lib/topicMap";
...
export const ProfileAPI = {
  ...
  async saveOnboardingData(data: OnboardingData): Promise<UserProfile> {
    try {
      ...
      // Validate exam is enabled
      if (!isExamEnabled(data.examType)) {
        throw new ProfileApiError('EXAM_DISABLED: This exam is not available yet.');
      }
